...
//    }
    ...
    holder.itemView.textView42.setOnClickListener {
...
//        i_Count.add(0,"0")
        ...
        ad_.clicl(object : adapter_count_shop.data_i {
            override fun Data_d(I: Int, Id: String) {
                if (I==0)
                {
//                    holder.itemView.textView42.setText("افزودن به سبد خرید")

                    notifyItemRemoved(position)

                }else{
                    holder.itemView.textView42.setText(I.toString()+" عدد ")
                }
...
//        holder.itemView.textView87.setText(V?.get(position)?.pricePayForShow.toString().trim())
//
//
//
...
//                holder.itemView.textView86.setText("${Item.discountPercent.toString().trim()}%")
//            }else{
...
////            holder.itemView.textView86.visibility=View.VISIBLE
//            holder.itemView.textView88.setText(V?.get(position)?.priceForShow.toString().trim())
//            holder.itemView.view6.setText(V?.get(position)?.priceForShow.toString().trim())
//        }else{
//            Log.i("dknvnsnvnds", "B")
